...
// POST /api/butin/projets/[id]/depense — dépense ou entrée sur un projet
...
export async function POST(request: NextRequest, { params }: RouteParams): Promise<NextResponse> {
  ...
  return NextResponse.json({ error: 'Utilise /api/butin/projets/[id]/depense' }, { status: 405 })
}