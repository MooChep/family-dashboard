...
// GET /api/butin/regul?month=2026-03  → array des réguls du mois
// GET /api/butin/regul                → toutes les réguls
...
// POST /api/butin/regul — toujours créer une nouvelle régul (snapshot du jour)
