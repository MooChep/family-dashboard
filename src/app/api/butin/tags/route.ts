...
// GET /api/butin/tags — liste tous les tags uniques avec leur nb d'utilisations
...
// PATCH /api/butin/tags — renommer un tag sur toutes les transactions
...
// DELETE /api/butin/tags — supprimer un tag de toutes les transactions
