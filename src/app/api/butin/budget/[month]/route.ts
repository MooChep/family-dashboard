...
import { normalizeMonth, formatMonth } from '@/lib/butin'
...
// ── PATCH /api/butin/budget/[month] ────────────────────────────────────────
/**
 * Valide le budget du mois (DRAFT → VALIDATED).
 * Déclenche la mise à jour du targetAmount des projets de butin
...
export async function PATCH(
  ...
  // ── Met à jour les targetAmount des projets de butin ────────────────────
