...
export async function PATCH(
  ...
  try {
    ...
    console.error('[gamelle/recipes/:id PATCH]', error)
    return Response.json({ success: false, error: 'Erreur serveur' } satisfies ApiResponse<never>, { status: 500 })
  }
}

// DELETE /api/gamelle/recipes/[id]
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[gamelle/recipes/:id DELETE]', error)
    return Response.json({ success: false, error: 'Erreur serveur' } satisfies ApiResponse<never>, { status: 500 })
  }
}
