...
const NAV_ITEMS = [
  ...
  { label: 'Menu',     href: '/gamelle/menu',     icon: CalendarDays  },
  { label: 'Courses',  href: '/gamelle/courses',  icon: ShoppingCart  },
  { label: 'Stock',    href: '/gamelle/stock',    icon: Archive       },
]

export function GamelleBottomNav(): React.ReactElement {
  const pathname = usePathname()

  if (!pathname.startsWith('/gamelle')) return <></>
  if (pathname.startsWith('/gamelle/cuisine'))  return <></>
