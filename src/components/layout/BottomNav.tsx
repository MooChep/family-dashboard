...
export function BottomNav(): React.ReactElement {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 border-t flex items-center justify-around z-[100] md:hidden bg-[var(--surface)] border-[var(--border)] px-1 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
      ...
      {EPARGNE_ITEMS.map((item) => {
        ...
        return (
          ...
          >
            ...
            {active && (
              <div className="absolute top-0 w-10 h-0.5 rounded-b-full bg-[var(--accent)] shadow-[0_0_8px_var(--accent)]" />
            )}
          </Link>
        )
      })}
