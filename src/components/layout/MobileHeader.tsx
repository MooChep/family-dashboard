...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/butin':                     'Butin',
  '/butin/mois':                'Mois',
  '/butin/analyses':            'Analyses',
  '/butin/analyses/depenses':   'Dépenses',
  '/butin/analyses/global':     'Global',
  '/butin/analyses/tags':       'Tags',
  '/butin/regul':               'Régularisation',
  '/butin/gestion':             'Gestion',
  '/butin/categories':          'Catégories',
  '/menage':                      'Ménage',
  '/projets':                     'Projets',
  '/gamelle':                     'Gamelle',
