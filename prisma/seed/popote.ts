...
/**
 * Seed Popote : rayons + ingrédients courants.
 ...
 */
export async function seedPopote(prisma: PrismaClient): Promise<void> {
  console.log('🥘 Seeding Popote — rayons + ingrédients...')
  ...
  console.log('🎉 Seed Popote terminé !')
}
